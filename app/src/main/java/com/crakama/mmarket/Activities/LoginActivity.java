...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //FaceBook callback manager to handle login responses
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        // the auth state listener will be notified and the logic to handle the
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                           ...
                           // String image=task.getResult().getUser().getPhotoUrl().toString();
                            ...
                            UserModel user = new UserModel(uid,name,null,email,null);
                            ...
                            userintent.putExtra("user_id",uid);
                            userintent.putExtra("profile_picture",image);
